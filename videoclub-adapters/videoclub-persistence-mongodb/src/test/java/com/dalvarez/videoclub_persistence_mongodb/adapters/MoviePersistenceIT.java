package com.dalvarez.videoclub_persistence_mongodb.adapters;
...
import com.dalvarez.videoclub_persistence_mongodb.config.TestConfig;
import com.dalvarez.videoclub_persistence_mongodb.service.SeederService;
...
class MoviePersistenceIT {
    ...
    @Test
    void testCreateExpectedIllegalArgumentExceptionThrown() {
        Movie movie = Utils.getDefaultMovie();
        movie.setId(null);

        assertThrows(IllegalArgumentException.class, () -> moviePersistence.create(movie));
    }
