package org.dalvarez.videoclub.rest_web.utils;
...
public class Utils {
    ...
    public static final String DEFAULT_MOVIE_DESCRIPTION = "Cars...";
    ...
    public static List<Category> getDefaultCategoryList() {
        return Arrays.asList(
                Category.builder().id(DEFAULT_CATEGORIES_ELEMENT1_ID).name("Action").build(),
                Category.builder().id(DEFAULT_CATEGORIES_ELEMENT2_ID).name("Races").build(),
                Category.builder().id(DEFAULT_CATEGORIES_ELEMENT3_ID).name("Fantasy").build()
        );
    }
